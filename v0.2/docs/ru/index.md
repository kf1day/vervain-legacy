...
### Паттерн
Паттерн определяет один или несколько сегментов URI, разделенных прямым слешем.
...
Значение, определенное маскированной локацией всегда будет являтся аргументом в методе контроллера
