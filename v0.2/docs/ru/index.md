...
# Описание
Vervain – легковесный мульти-сайтовый MVC-фреймворк, который создавался в первую очередь для упрощенного сопоставления набора URI с их обработчиками ([контроллерами](#ctrl)). Сопоставления описываются в виде дерева [паттернов](#pattern), описаном в файле [sitemap.php](#sitemapfile)
...
## <a id="sitemapfile">Файл sitemap.php</a>
